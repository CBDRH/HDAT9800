...
description: "UNSW Health Data Science: visualisation of categorical data"
...
arthritis_txt <- read.delim("extdata/arthritis.txt")
...
`HairEyeColor` from the inbuilt `datasets` package contains data for a survey of individuals, recording hair color, eye color, and gender of 592 individuals.  It is stored in cross tablulated (table) form. Thus

```{r hec, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
HairEyeColor
...
```{r hec-explore, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
class(HairEyeColor)
str(HairEyeColor)
...
```{r hec-expand, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r case-form, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%", warning=FALSE, message=FALSE}
names(Arthritis)
str(Arthritis)
head(Arthritis,5)
...
```{r freq-form, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r freq-drop, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r txt-ordered, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
str(arthritis_txt)
...
```{r ordered, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r mosiac-arthritis, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
arthritis_txt$Improved <- ordered(arthritis_txt$Improved, levels=c("None", "Some", "Marked"))
...
```{r aperm-arthritis, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
ftable(HairEyeColor)
...
```{r freq-table, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%", warning=FALSE, message=FALSE}
set.seed(1010)
n=500
...
```{r xtabs-formula, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
head(GSS)
...
```{r struct-table, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
structable(HairEyeColor) # show the table: default

```


```{r struct-colrows, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r struct-mosiac, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r dayton, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
str(DaytonSurvey)
head(DaytonSurvey)
...
```{r dayton-aggregate, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r xtabs-structable, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
# in table form
...
```{r collapse-levels, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r arthritis-3way, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r ucb, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r ucb-odds, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
oddsratio(UCBAdmissions, log=FALSE)

```


```{r ucb-odds2, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r ucb-woolf, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r cot, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
UCB <- aperm(UCBAdmissions, c(2, 1, 3))
...
```{r doubledeck, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r mosiac-labels, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
UCB <- aperm(UCBAdmissions, c(2, 1, 3))
names(dimnames(UCB)) <- c("Sex", "Admit?", "Department")
dimnames(UCB)[[2]] <- c("Yes", "No")
...
```{r labels-mod, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r mosiac-max, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r mosiac-friendly, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r spine, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r spine-scott, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r cdplot-vcd, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r cdplot-rug, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r kappa, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
(K <- Kappa(SexualFun))
...
```{r agree-plot, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r hair-eye, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
data(HairEyeColor)
...
```{r balloon, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
df <- as.data.frame(HairEyeColor)
...
```{r hair-mosiac, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
...
```{r correspondence, echo=TRUE, exercise=TRUE, fig.width=8, fig.height=8, output.width="90%"}
